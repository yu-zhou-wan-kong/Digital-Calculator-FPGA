...
set_input_delay -clock [get_clocks -filter { NAME =~  "*" }] 0.000 [get_ports rst]
set_input_delay -clock [get_clocks -filter { NAME =~  "*" }] -min -0.500 [get_ports rst]
set_output_delay -clock [get_clocks -filter { NAME =~  "*" }] 0.000 [get_ports -filter { NAME =~  "*" && DIRECTION == "OUT" }]